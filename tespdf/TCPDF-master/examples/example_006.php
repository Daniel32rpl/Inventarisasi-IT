...
$phost="http://simrs.umm.ac.id/v2";
// create some HTML content
$html = '<h1>HTML Example</h1>
Some special characters: &lt; € &euro; &#8364; &amp; è &egrave; &copy; &gt; \\slash \\\\double-slash \\\\\\triple-slash
<h2>List</h2>
List example:
<img src="'.$phost.'/images/bpjs_logo.png" alt="logo" height="33"/>
<ol>
	<li><img src="http://simrs.umm.ac.id/v2/tespdf/TCPDF-master/examples/images/logo_example.png" alt="test alt attribute" width="30" height="30" border="0" /> test image</li>
	<li><b>bold text</b></li>
