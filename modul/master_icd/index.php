...
switch($act){
	default:
		...
		if($ndata>0){
			...
			while($fdata=mysqli_fetch_assoc($data)){
				...
				if($lmn[$idsmenu][3]==1){
					$link_hapus="$link_back&act=hapus&gid=$id&ghal=$ghal";
				...
				<div class=\"box\">
					...
					<div class=\"box-body\">
						<form role=\"form\" class=\"form-horizontal\" method=\"get\">
							...
							<div class=\"form-group\">
								<label class=\"col-sm-2 control-label text-left\">Nama ICD/Tindakan</label>
				...
				<div class=\"col-md-12\">
					<div class=\"box\">
						...
						<div class=\"box-body\">
							<div class=\"row\">
								<div class=\"col-md-12\">
									<form role=\"form\" class=\"form-horizontal\" method=\"post\" action=\"$link_back&act=proses&gket=$gket&ghal=$ghal\">
										<div class=\"form-group\">
										...
										<div class=\"form-group\">
		                    				<label class=\"col-sm-2\">Nama ICD/Tindakan</label>
		                    				<div class=\"col-sm-5\">
	...
	case"proses":
		...
		$error.=(empty($nama_penyakit))? "&bull; Nama ICD/Tindakan Masih Kosong<br />" : "";
